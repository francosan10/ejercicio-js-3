...
document.write(
  `<p>Los items de las posiciones son: <br><b>Primerera posición:</b> ${
    ciudades[0]
  } <br><b>Tercera posición:</b> ${ciudades[2]} <br><b>Ultima posición:</b> ${
...
ciudades.push("París");
document.write(
  `<p>La última posicion contiene a: ${ciudades[ciudades.length - 1]}</p>`
);
// Escribe por pantalla el elemento que ocupa la segunda posición.
document.write(
  `El elemento que ocupa la <b>segunda posición</b> es: ${ciudades[1]}`
);
// Arreglo de ciudades
